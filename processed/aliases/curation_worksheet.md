...
|---|---|---|---|---|---|
| [x] | `AF` | **tag** | AminoFormula | 56 | 2023/17yr Weight gain instruct, menu, Creatine in baseline w AF&Pro Stack, Parent note.docx: …h Creatine Monohydrate in Baseline with AF & Protein Stacking Click on product lin…<br>2023/3 days low, 1 day high inst with level 3 weight loss supp bundle .docx: …ein needs Workout Days: AminoFormula (AF) Take 1-scoop ~10 minutes before and m… |
...
| [x] | `LeanMR` | **tag** | LeanMeal Nutrition Shake (legacy rename) | 101 | 2023/17yr weight gain&note, FS in baseline, LeanMR in BaselineKatsMenus.docx: …imes for weight gain. You would use the LeanMR as shown in the meal replacement progra… |
...
| [x] | `AdvancedBrainHealth` | **tag** | Brain Health (legacy rename) | 17 | 2023/Adrenal burnout fatigue, dietExercise&prgm note, baseline&CompleteLongevity program, budget.docx: …rotein Bar based on venue convenience *Advanced Brain Health (may divide evenly or all at once anyti… |
| [x] | `Recover&Build` | **context-only** | AminoFormula (REPLACEMENT — different formula; currency cue and query redirect only, never a product tag) | 17 | 2023/Allergen warnings on AminoFormula, Ok for fish, complete manuf info.docx: …of the information. As Neal stated, the Recover & Build (BCAAs) is free of fish or shellfish as… |
...
| [x] | `VeganMV` | **tag** | discontinued (no successor) — currency cue only, never a product tag | 81 | 2023/17yr weight gain&note, FS in baseline, LeanMR in BaselineKatsMenus.docx: …n 12-17yr use 1-Active) ;All vegans use VeganMV LeanMR other favorite dotFIT protein m… |
